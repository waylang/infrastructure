%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% vim: set fenc=utf-8 ff=unix sts=2 sw=2 et ft=tex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                                                                              %
% This file's original template (see links and license block below) was        %
% released under ISC.                                                          %
%                                                                              %
% https://www.sharelatex.com/templates/books/easy-book                         %
% https://github.com/amberj/latex-book-template/blob/56dce81/book-template.tex %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{\Huge \textbf{Way} \\ \huge The Definitive Guide \\ Version \input{version}}
% Author
\author{\textsc{Phil Smith}}
